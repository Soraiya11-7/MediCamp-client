  ...
  return (
    <>
      ...
      <div className=" w-full   ">
        ...
        <h2 className="text-lg sm:text-xl md:text-3xl my-3 text-center ">Welcome,
          <span className='text-green-900 font-bold dark:text-white'> {userInfo?.name?.split(" ")[0]}!</span>
