      ...
      <div className="w-[90%] container mx-auto">
        ...
        <div className="grid grid-cols-1 w-[90%] mx-auto sm:w-full sm:grid-cols-2 md:grid-cols-4 gap-4">
          {experts.map((expert, idx) => (
            <div
              key={idx}
              className="bg-white rounded-b-lg shadow-md text-center hover:shadow-xl transition-all duration-300 border border-transparent hover:border-4 hover:border-green-900 dark:hover:border-yellow-600"
              data-aos="fade-up"
